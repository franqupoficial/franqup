...
// Dados fictícios do perfil do franqueado para demonstração
const mockProfileData = {
  name: 'João da Silva',
  email: 'franqueado@franqup.com',
  memberSince: 'Janeiro de 2025',
  totalRequests: 15,
};

export default function FranqueadoProfilePage() {
  return (
    <div>
      <h2 className="text-3xl font-bold mb-6">Meu Perfil</h2>
      <p className="text-gray-400 mb-8">Informações da sua conta e desempenho como franqueado.</p>
        ...
        <div className="mt-8 space-y-6">
          <div>
            ...
            <ul className="mt-2 text-gray-400 space-y-2">
              ...
              <li className="flex justify-between items-center">
                <span>ID do Franqueado (fictício):</span>
                <span className="text-white font-medium">seu-id-de-franqueado-aqui</span>
              </li>
            </ul>
          </div>

          <div>
            <h4 className="text-lg font-semibold text-gray-300">Estatísticas</h4>
            <ul className="mt-2 text-gray-400 space-y-2">
              <li className="flex justify-between items-center">
                <span>Total de Solicitações:</span>
                <span className="text-white font-medium">{mockProfileData.totalRequests}</span>
              </li>
            </ul>
          </div>
        </div>
